...
let getIngrements = document.querySelector(".getIngrements");
...
getIngrements.addEventListener("click", (e) => {
    getIngredients();
    closeSideNav();
})
...
async function getArea() {
    ...
    $(".inner-loading-screen").fadeIn(500);
    searchContainer.innerHTML ="";
    let response = await fetch(`https://www.themealdb.com/api/json/v1/1/list.php?a=meals`);
    response = await response.json()
...
function showSearchInputs() {
    ...
    <div class="col-md-6 ">
        <input onkeyup="searchByName(this.value)" class="form-control searchInput bg-transparent text-white" type="text" placeholder="Search By Name">
    </div>
    <div class="col-md-6">
        <input onkeyup="searchByFLitter(this.value)" maxlength="1" class="form-control searchInput bg-transparent text-white" type="text" placeholder="Search By First Letter">
    </div>
</div>`
rowData.innerHTML = ""
}
